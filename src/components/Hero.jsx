      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-32 sm:px-6 lg:px-8 text-center">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-black leading-tight">
            ...
            <span className="block text-blue-500 mt-2">Event Experiences</span>
          </h1>
          <p className="mt-6 max-w-3xl mx-auto text-xl text-gray-200 leading-relaxed Playfair-Display tracking-wide">
